...
export default function CodePanel({
  ...
  const executionResult = externalExecutionResult ?? localExecutionResult
  ...
  useEffect(() => {
    if (selectedFrame) {
      ...
      // Only clear success messages, keep errors visible
  ...
  return (
    <div className="h-full p-4 flex flex-col min-h-0 overflow-hidden">
      ...
      {executionResult && (
        !executionResult.success || (!showLoading && !isRunning && !isExecuting)
      ) && (
